...
public abstract class Element implements Serializable, Cloneable {
    ...
    private SimpleActivity simpleActivity = null;
    ...
    public void setParentCompositeActivity(CompositeActivity compositeActivity) {
        this.compositeActivity = compositeActivity;
    }

    public CompositeActivity getParentCompositeActivity() {
        return compositeActivity;
    }
    

    public void setParentsimpleActivity(SimpleActivity simpleeActivity) {
        this.simpleActivity = simpleActivity;
    }

    public SimpleActivity getParentSimpleActivity() {
    ...
    public Element getClone() {
        try {
            ...
            element.compositeActivity = this.compositeActivity;
            return element;
