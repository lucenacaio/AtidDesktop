...
class PanningFeature implements Feature {
    ...
    private void doThePanning(int mouseX, int mouseY) {
        Point viewTranslation = Atid.getRoot().getDocument().petriNet.getCurrentCompositeActivity().getViewTranslation();
        viewTranslation.translate(mouseX - prevDragX, mouseY - prevDragY);
        Atid.getRoot().getDocument().petriNet.getCurrentCompositeActivity().setViewTranslation(viewTranslation);
    }
