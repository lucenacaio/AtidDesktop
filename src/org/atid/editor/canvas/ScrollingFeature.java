...
public class ScrollingFeature implements Feature, MouseListener, MouseMotionListener, AdjustmentListener {
    ...
    public void drawMainLayer(Graphics g) {
        Rectangle petriNetBounds = Atid.getRoot().getDocument().petriNet.getCurrentCompositeActivity().getBounds();
        Rectangle canvasBounds = canvas.getBounds();

        JScrollBar horizontalScrollBar = Atid.getRoot().getDrawingBoard().getHorizontalScrollBar();
        JScrollBar verticalScrollBar = Atid.getRoot().getDrawingBoard().getVerticalScrollBar();
