...
public class PngFileType extends FileType {
    ...
    @Override
    public Icon getIcon() {
        final Icon icon = GraphicsTools.getIcon("atid/filechooser/png.gif");
        return icon;
    }
    ...
    public void save(Document document, File file) throws FileTypeException {
        try {
            ...
            BufferedImage bufferedImage = document.petriNet.getCurrentCompositeActivity().getPreview(initialMarking);
