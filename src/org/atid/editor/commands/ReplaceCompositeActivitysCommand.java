 ...
 */
public class ReplaceCompositeActivitysCommand implements Command {

    private Set<Command> replaceCompositeActivitys = new HashSet<Command>();

    public ReplaceCompositeActivitysCommand(Set<CompositeActivity> compositeActivitys, CompositeActivity storedCompositeActivity, PetriNet petriNet) {
        for (CompositeActivity compositeActivity : compositeActivitys) {
            replaceCompositeActivitys.add(new ReplaceCompositeActivityCommand(compositeActivity, storedCompositeActivity, petriNet));
        }
    }
