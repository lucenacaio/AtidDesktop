...
import org.atid.editor.commands.PasteCommand;
...
public class PasteAction extends AbstractAction {
    ...
    public PasteAction(Root root) {
        ...
        String name = "Paste";
        putValue(NAME, name);
        putValue(SMALL_ICON, GraphicsTools.getIcon("atid/Paste16.gif"));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        root.getUndoManager().executeCommand(new PasteCommand(pastedElements, root.getDocument().petriNet.getCurrentCompositeActivity(), petriNet));
