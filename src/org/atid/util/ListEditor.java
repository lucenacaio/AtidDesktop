...
public class ListEditor<E> extends JPanel implements ActionListener, ListSelectionListener {
    ...
    public ListEditor(String title, ListModel<E> model, Frame parent) {
        ...
        addButton.setIcon(GraphicsTools.getIcon("atid/Add16.gif"));
        editButton.setIcon(GraphicsTools.getIcon("atid/Preferences16.gif"));
        deleteButton.setIcon(GraphicsTools.getIcon("atid/Remove16.gif"));
